...
@Configuration
@PropertySource("classpath:persistence-pslq.properties")
@EnableJpaRepositories("com.romantupikov.lesson3.repository")
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.romantupikov.lesson3.entity");
